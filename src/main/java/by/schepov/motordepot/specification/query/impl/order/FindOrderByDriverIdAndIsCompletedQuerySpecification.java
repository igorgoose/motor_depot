...
public class FindOrderByDriverIdAndIsCompletedQuerySpecification implements QuerySpecification<Order> {

    private int driverId;
    private boolean isCompleted;
    private static final Logger LOGGER = LogManager.getLogger(FindOrderByDriverIdAndIsCompletedQuerySpecification.class);
    private static final String QUERY =
            "SELECT orders.id id, user_id, departure_location, arrival_location, car_id, is_complete, " +
                    ...
                    "WHERE cars.driver_id = ? AND is_complete = ?";
    private final ConnectionPool pool = ConnectionPool.INSTANCE;

    public FindOrderByDriverIdAndIsCompletedQuerySpecification(int driverId, boolean isCompleted) {
