...
public class FindUserByIdQuerySpecification implements QuerySpecification<User> {

    private int id;
    private static final Logger LOGGER = LogManager.getLogger(FindUserByIdQuerySpecification.class);
    ...
    public FindUserByIdQuerySpecification(int id) {
        this.id = id;
    }
