            ...
            <form class="login100-form validate-form flex-sb flex-w" action="controller" method="post">
                ...
                <div class="container-login100-form-btn m-t-17">
                    <button class="login100-form-btn" >
                        <fmt:message bundle="${bundle}" key="home.login.button"/>
                    </button>
                </div>

                <div class="container-login100-form-btn m-t-17">
                    <button class="login100-form-btn" name="language" value="en">
                        English
                    </button>
                </div>
                <div class="container-login100-form-btn m-t-17">
                    <button class="login100-form-btn" name="language" value="ru">
                        Русский
                    </button>
                </div>
                <div>
